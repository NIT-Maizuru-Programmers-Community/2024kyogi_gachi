...
class main(judge.Judgec,algorithm_random.algorithm_tentative,board_reload_fujii.BoardOperation):
    ...
    def algorithm_execution(self):
        ...
        self.call_algotithm=self.algo_rand(self.now_board,self.correct_board,self.use_type,self.width,self.height)#アルゴリズム呼び出し
