...
#logへの書き出しありのバージョン
#log_softで見れるように
class simu(judge.Judgec,algorithm_shuffle.algorithm_tentative,board_reload_fujii.BoardOperation):
    ...
    def set(self):
        ...
        self.width=len(first_board[0])
        self.hight=len(first_board)
    ...
    def relord_judge_log(self):
        ...
        self.call_algotithm=self.algo(self.now_board,self.correct_board,self.use_type,self.width,self.hight)#アルゴリズム呼び出し,
